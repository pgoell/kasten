...
* [Todo format](todo-format.md) - the line a todo is written on, every field it carries, the five states, the cycle, the done log, the time log, and the terms that filter one
