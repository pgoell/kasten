...
* [Books in the vault](books-in-the-vault.md) - why a book is its note's path with the suffix swapped, the two doors one comes in by, and why the vault's history never takes a copy of one
